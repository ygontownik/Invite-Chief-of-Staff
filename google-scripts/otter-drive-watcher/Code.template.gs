...
/**
 * otter-drive-watcher.template.gs
 *
 * Google Apps Script — Otter Drive Watcher (multi-tenant template).
 *
 * Polls a tenant-defined list of Otter Drive folders every N minutes.
 ...
 *   1. Replace __OTTER_FOLDER_IDS__ with a JS array literal of tenant Drive
 *      folder IDs sourced from `firm_context.yaml :: otter_folders[]`.
 *      Example: ["1abc...", "1def..."]
 *   2. Project Settings → Script Properties → Add:
 *        SERVER_URL      <dashboard-server-webhook-url>
 *        WEBHOOK_SECRET  <shared-secret, rotated per tenant>
 *   3. Run installTrigger() once to create the repeating trigger.
 *   4. Authorize Drive and UrlFetch scopes when prompted.
 *
 ...
 *   - Server down: muteHttpExceptions=true; non-2xx is logged but not thrown
 */

var FOLDER_IDS = __OTTER_FOLDER_IDS__;
